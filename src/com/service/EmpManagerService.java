...
public interface EmpManagerService {
	...
	/**
	 * @param mgr 登录的经理身份
	 * @return 登陆后的身份确认： 0--失败，1--emp，2--mgr
	 */
	...
	/**
	 * 验证某个员工是否可以打卡
	 * @param userString 员工姓名
	 * @param dutyDay	日期
	 * @return 可打卡的类别
	 */
	int validPunch(String userString,String dutyDay);
	...
	/**
	 *  根据员工姓名浏览自己的工资
	 * @param empNameString 员工名
	 * @return	该员工的工资列表
	 */
	List<PaymentBean> empSalary(String empNameString);
